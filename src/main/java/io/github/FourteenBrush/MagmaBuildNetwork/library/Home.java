...
public class Home extends LibraryProvider implements ConfigurationSerializable {

    private final String name;
    private final Location location;
    private final UUID owner;
    private static final FileConfiguration homesFile = plugin.getConfigManager().getHomes();
