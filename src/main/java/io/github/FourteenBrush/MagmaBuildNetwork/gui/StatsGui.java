...
public class StatsGui extends GuiCreator {
    ...
    public StatsGui(Player player) {
        super("Stats", 6);
        setItem(10, createItem(Material.STONE_PICKAXE, PlayerUtils.getTotalMinedStones(player) + " blocks mined", null));
        ...
        setItem(31, createItem(Material.IRON_AXE, PlayerUtils.getTotalChoppedLogs(player) + " logs chopped", null));
    }
}
